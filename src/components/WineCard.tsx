...
const WineCard = ({ name, region, year, rating, type, image }: WineCardProps) => {
  ...
  return (
    <div 
      className="group relative rounded-lg overflow-hidden transition-all duration-500 h-[400px] wine-glass"
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 transform transition-transform duration-500 ease-wine-bounce">
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="h-10 w-10 rounded-full flex items-center justify-center bg-wine hover:bg-wine-light transition-colors duration-300">
