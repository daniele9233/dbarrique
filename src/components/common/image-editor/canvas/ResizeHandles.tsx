...
const ResizeHandles = ({ imageUrl }: ResizeHandlesProps) => {
  ...
  return (
    <>
      ...
      <div 
        className="resize-control absolute w-24 h-24 bg-wine/90 rounded-full bottom-8 right-8 cursor-se-resize transform translate-x-1/2 translate-y-1/2 border-4 border-white flex items-center justify-center touch-manipulation z-30 animate-pulse"
      ...
      >
        ...
        <span className="absolute -top-9 right-0 bg-noir-dark/95 px-3 py-2 rounded text-sm text-white whitespace-nowrap border border-white/30 shadow-lg">
